...
export default (function () { return (React.createElement("svg", { viewBox: "0 0 266 150", fill: "none" },
    ...
    React.createElement("rect", { x: 95, y: 58, width: 76, height: 4, rx: 2, 
        //   fill="var(--base-500)"
        className: "fill-current text-gray-500" }),
    React.createElement("rect", { x: 123, y: 94, width: 20, height: 2, rx: 1, 
        // fill="var(--main-500)"
        className: "fill-current text-gray-500" }),
    React.createElement("rect", { x: 89, y: 66, width: 88, height: 4, rx: 2, 
        //   fill="var(--base-500)"
        className: "fill-current text-gray-500" }),
    React.createElement("rect", { x: 92, y: 74, width: 83, height: 4, rx: 2, 
        //   fill="var(--base-500)"
        className: "fill-current text-gray-500" }),
    React.createElement("rect", { x: 103, y: 82, width: 60, height: 4, rx: 2, 
        // fill="var(--base-500)"
        className: "fill-current text-gray-500" }),
    React.createElement("rect", { x: 113, y: 104, width: 40, height: 4, rx: 2, 
        // fill="var(--solid-900)"
        className: "fill-current text-gray-900" }),
    React.createElement("rect", { x: 106, y: 112, width: 54, height: 4, rx: 2, 
        // fill="var(--base-400)"
