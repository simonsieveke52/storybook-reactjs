...
function PrivacyBarrier() {
    var context = (0, react_1.useContext)(Contexts_1.FieldContext);
    return context.secured ? (react_1.default.createElement("div", { className: "private-field inset-0 absolute z-50 bg-white", style: {
            backgroundImage: 
...
exports.default = PrivacyBarrier;
